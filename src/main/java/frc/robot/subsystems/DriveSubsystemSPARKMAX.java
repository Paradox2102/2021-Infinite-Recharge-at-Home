...
public class DriveSubsystemSPARKMAX extends SubsystemBase implements DriveSubsystem {
  ...
  CANPIDController m_leftPIDController;
  CANPIDController m_rightPIDController;
  ...
  public DriveSubsystemSPARKMAX() {
    ...
    m_rightPIDController = m_rightDrive.getPIDController();

    m_leftPIDController.setI(k_iLeft);
    m_leftPIDController.setP(k_pLeft);
    m_leftPIDController.setFF(k_fLeft);
    m_leftPIDController.setD(k_dLeft);
    m_leftPIDController.setIZone(k_iRange);
    m_leftPIDController.setOutputRange(-1, 1);

    m_rightPIDController.setI(k_iRight);
    m_rightPIDController.setP(k_pRight);
    m_rightPIDController.setFF(k_fRight);
  ...
  public void setPower(double leftPower, double rightPower) {
    ...
    m_rightPIDController.setReference(rightPower, ControlType.kDutyCycle);
  ...
  public void setSpeed(double leftSpeed, double rightSpeed) {
    m_rightPIDController.setReference(rightSpeed, ControlType.kVelocity);
    m_leftPIDController.setReference(leftSpeed, ControlType.kVelocity);
  ...
  public void setSpeedFeet(double leftSpeed, double rightSpeed) {
    setSpeed(feetToTicks(leftSpeed * 60.0), feetToTicks(rightSpeed * 60.0));
  }
