...
import frc.robot.commands.Auto.TrenchRun.MoveBack3Ball;
...
public class FiveWheel extends ParallelCommandGroup {
  /** Creates a new FiveWheel. */
  public FiveWheel(DriveSubsystem driveSubsystem, ShooterSubsystem shooterSubsystem,
      ShooterAngleSubsystem shooterAngleSubsystem, TurretSubsystem turretSubsystem, ThroatSubsystem throatSubsystem,
      SerializerSubsystem serializerSubsystem, IntakeSubsystem intakeSubsystem, Camera frontCam, Camera backCamera,
      double shootSpeed) {
    addCommands(
