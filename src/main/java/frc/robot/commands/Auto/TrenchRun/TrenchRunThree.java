...
public class TrenchRunThree extends ParallelCommandGroup {
  /** Creates a new TrenchRunThree. */
  public TrenchRunThree(DriveSubsystem driveSubsystem, ShooterSubsystem shooterSubsystem,
