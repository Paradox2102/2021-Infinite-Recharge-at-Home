...
public class MoveBack3Ball extends SequentialCommandGroup {
  /**
   * Creates a new TrenchForwardBack.
   */

  final static Waypoint[] k_backwardsTrench = { new Waypoint(-11, 11, Math.toRadians(90), 5),
      new Waypoint(-11, 16, Math.toRadians(90)) };


  public MoveBack3Ball(DriveSubsystem driveSubsystem) {
