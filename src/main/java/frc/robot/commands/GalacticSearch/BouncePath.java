...
public class BouncePath extends ParallelCommandGroup {
  ...
  static final Waypoint[] k_legOne = { 
     ...
     static final Waypoint[] k_legTwo = { 
      new Waypoint(-3.5, 7.5, Math.toRadians(0), 3, 1, 0),
      new Waypoint(5.25, 12.5, Math.toRadians(90), 2, 6, 0),
      new Waypoint(-3.75, 15, Math.toRadians(180)),
     };
     static final Waypoint[] k_legThree = { 
      new Waypoint(-3.75, 15, Math.toRadians(0)),
      new Waypoint(5.5, 18.25, Math.toRadians(90)),
      new Waypoint(-3.75, 22.5, Math.toRadians(180)),
     };
     static final Waypoint[] k_legFour = { 
      new Waypoint(-3.75, 22.5, Math.toRadians(0)),
